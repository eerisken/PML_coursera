...
Then, a model-based-prediction "Quadratic Discriminant Analysis (qda)"  model was built by using the "caret" package and its predictions and accuracy were calculated by related commands from the same "caret" package.
...
# build the model
model <- train(classe~., method="qda", data= training)
